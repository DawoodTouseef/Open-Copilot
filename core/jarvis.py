try:
    ...
    from core.agent.assistant import *
    from core.llm import *
    from core.llm_settings import llm_settings
    from core.agent.agent import *
    from core.agent.background import *
    from core.utils.db import *
    from core.gui.signal import *
    from core.gui.button import *
    from core.gui.settings import settings_popup
    from core.gui.llmsettings import llmsettings_popup
    from core.utils.telemetry import my_tracer, os_name
    from core.audio.wake_word import wake_word
    from core.audio.tts import text_to_speech
import platform
import threading
import time
import random
        ...
        while True and is_wake_word_active() and self.wake_word_active:
            if wake_word(self):
                ...
                def random_accept_words():
                    return random.choice(["Yes", "Sir", "Boss", "Master","Ma'am"])
