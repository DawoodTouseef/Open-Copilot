...
try:
    ...
    from core.audio.stt import speech_to_text
    from core.gui.signal import signal_handler
...
def tts_if_you_can(
    ...
    try:
        try:
            ...
            from core import the_main_window
...
def process_audio(take_screenshot=True, take_system_audio=False, dont_save_image=False):
    with my_tracer.start_span("process_audio") as span:
        ...
        try:
            ...
            from ..jarvis import the_input_box, the_main_window
            from ..audio.record import audio_data
