try:
    ...
    from .stt_providers.nexusai import stt_nexusai
except ImportError:
    from core.utils.db import *
    from core.audio.stt_providers.openai import stt_openai
    from core.audio.stt_providers.openai_whisper_local import stt_openai_whisper_local
    from core.audio.stt_providers.nexusai import stt_nexusai
    ...
    for part, part_path in audio_parts:
        with open(part_path, "rb") as audio_file:
            try:
                ...
                elif load_stt_model_settings() == "NexusAI":
                    transcription = stt_nexusai(audio_file,part_path)
                else:
