...
try:
    ...
    from core.screen.shot import *
    from core.agent.process import *
    from core.utils.db import (
        screenshot_path,
    )
    from core.screen.shot import take_screenshot
...
class ButtonHandler:
    ...
    def toggle_recording(
        ...
        try:
            ...
            from core.audio.record import stop_recording, start_recording
