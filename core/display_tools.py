...
def appopener_(app_name:str):
    """
    open any application without knowing it's absolute path in the system.For Example:brave,chrome,whatsapp,etc..
    """
    ...
    try:
        ...
        if os_name not in ['Linux']:
            ...
            return "I cannot open the Application."
    except Exception as e:
        return f"Application cannot be found"


app_opener=tool(appopener_)

def appcloser_(app_name:str):
    """
    close any application without knowing it's absolute path in the system.For Example:brave,chrome,whatsapp,etc..
    """
    ...
    try:
        ...
        if os_name not in ['Linux']:
            ...
            return "I cannot close the Application."
    except Exception as e:
        return f"Application is Already closed"


app_closer=tool(appcloser_)
